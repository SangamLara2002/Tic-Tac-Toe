...
scanf("%d",&choice);
if(board[choice-1]=='x' || board[choice-1]=='0' || choice>9 || choice<1){
    printf("\n                              Invalid Move");
    getch();
    continue;
}
...
system("cls");
printf("\n\n");
printf("1. The game is Played on a grid that's 3 square by 3 square.\n2. Two players are required for the game.");
printf("\n3.  If First player is X , then other one is 0.\n4. Players take turn putting their symbols in empty squares.");
...
printf("\n7.  When all the 9 squares get filled, game is over.\n8. If no player has 3 symbols in a sequence mentioned above in Rule no. 6, the game in a tie.");
printf("\n\n            1.Main Menu                         2.Exit\n");
int choice;
printf("\n\n                         Enter Your Choice:");
scanf("%d",&choice);
